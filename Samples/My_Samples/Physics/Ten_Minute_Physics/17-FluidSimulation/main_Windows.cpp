					  ...
					  _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    wi::helper::StringConvert("17 - Fluid Simulation", szTitle, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WICKEDENGINESAMPLES));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW, rect.left,
